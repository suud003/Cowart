...
| --- | --- |
| 建立视觉项目全景 | 世界语气、玩家循环、用户访谈、TAPD 任务和风险约束集中在一张画布 |
...
视觉项目画布把参考图、氛围色板、核心循环、机制备忘、用户原话、TAPD 任务和风险便签放在同一个空间。Codex 入口保持在右下角，需要时展开为覆盖式工作台；画布不会被挤压，团队可以一边看全局，一边让 Agent 整理选区或生成 PRD。
