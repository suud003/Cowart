...
const requiredPaths = [
  ...
  path.join(runtimeRoot, 'mcp', 'lib', 'canvas-project-storage.mjs'),
  ...
  path.join(runtimeRoot, 'src', 'CanvasNavigator.jsx'),
...
const sourceParityPaths = [
  ...
  path.join('mcp', 'lib', 'canvas-project-storage.mjs'),
  ...
  path.join('src', 'CanvasNavigator.jsx'),
